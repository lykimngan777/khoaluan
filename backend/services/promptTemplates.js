...
- Cuối giai đoạn này, hãy đề xuất 5 ngành nghề triển vọng nhất đã vượt qua các bộ lọc loại trừ để người dùng chọn đưa vào Shortlist (tối đa 5 nghề).
...
MỤC TIÊU GIAI ĐOẠN NÀY:
- Lấy danh sách tối đa 5 nghề thuộc Shortlist từ giai đoạn trước.
